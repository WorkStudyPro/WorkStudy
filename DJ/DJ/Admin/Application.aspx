<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master.master" AutoEventWireup="true" CodeFile="Application.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" Style="margin-left: 118px; position: absolute; margin-top: 92px;" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="1320px" PageSize="8">
        ...
        <Columns>
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#1ECDB9" CausesValidation="false" CommandName="" OnClick="LinkButton1_Click" Text="审核通过"></asp:LinkButton>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="7%" />
            </asp:TemplateField>
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" ForeColor="Red" runat="server" CausesValidation="false" CommandName="" OnClick="LinkButton2_Click" Text="驳回申请"></asp:LinkButton>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="7%" />
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:constr %>" SelectCommand="SELECT [M_ID], [W_Name], [W_Place], [W_Description], [W_People], [W_Time], [W_ReleaseTime], [W_Money] FROM [Table_Work] WHERE [W_State]='1' ORDER BY [M_ID], [W_ReleaseTime] DESC "></asp:SqlDataSource>
</asp:Content>
