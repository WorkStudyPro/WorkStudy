<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master.master" AutoEventWireup="true" CodeFile="Merchants.aspx.cs" Inherits="_Default" %>
     ...
     <asp:ListView ID="ListView1" runat="server" DataKeyNames="M_ID" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem">
         <AlternatingItemTemplate>
             <tr style="background-color: #FFFFFF;color: #284775;height:50px;">
                 ...
                 <td Style="text-align:center">
                     <asp:Button ID="EditButton" width="70px" Font-Size="17px" ForeColor="#1ecdb9" BackColor="White" style="cursor:pointer" runat="server" CommandName="Edit" Text="修改信息" />
                 </td>
                 <td Style="text-align:center">
         ...
         <EditItemTemplate>
             <tr style="background-color: white;height:50px;text-align:center;">
                 ...
                 <td>
                     <asp:TextBox ID="M_PassWordTextBox" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center" width="140px" runat="server" Text='<%# Bind("M_PassWord") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_PrincinpleTextBox" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center" width="120px" runat="server" Text='<%# Bind("M_Princinple") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_NameTextBox" width="150px" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center" runat="server" Text='<%# Bind("M_Name") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_SexTextBox" width="80px" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center" runat="server" Text='<%# Bind("M_Sex") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_TeleTextBox" width="120px" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center"  runat="server" Text='<%# Bind("M_Tele") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_AdressTextBox" width="150px" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center"  runat="server" Text='<%# Bind("M_Adress") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_EmailTextBox" width="180px"  Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center" runat="server" Text='<%# Bind("M_Email") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_CreaditRatingTextBox" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center"  width="80px" runat="server" Text='<%# Bind("M_CreaditRating") %>' />
                 </td>
                 <td>
                     <asp:TextBox ID="M_LoginTimeTextBox" Font-Size="16px" Style="color:RGBA(165,165,166,39);text-align:center" Width="185px" runat="server" Text='<%# Bind("M_LoginTime") %>' />
                 </td>
                 <td>
         ...
         <ItemTemplate>
             <tr style="background-color: #E0FFFF;color: #333333;height:50px;text-align:center">
                
                 <td Style="text-align:center">
                     <asp:Label ID="M_IDLabel" width="110px"    runat="server" Text='<%# Eval("M_ID") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_PassWordLabel" width="140px"  runat="server" Text='<%# Eval("M_PassWord") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_PrincinpleLabel" width="120px"  runat="server" Text='<%# Eval("M_Princinple") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_NameLabel" width="150px"  runat="server" Text='<%# Eval("M_Name") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_SexLabel" width="80px"  runat="server" Text='<%# Eval("M_Sex") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_TeleLabel" width="120px"  runat="server" Text='<%# Eval("M_Tele") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_AdressLabel" width="150px"  runat="server" Text='<%# Eval("M_Adress") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_EmailLabel" width="180px"  runat="server" Text='<%# Eval("M_Email") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Label ID="M_CreaditRatingLabel"  width="80px"  runat="server" Text='<%# Eval("M_CreaditRating") %>' />
                 </td>
                 <td>
                     <asp:Label ID="M_LoginTimeLabel" width="185px"  runat="server" Text='<%# Eval("M_LoginTime") %>' />
                 </td>
                 <td Style="text-align:center">
                     <asp:Button ID="EditButton"  width="70px" Font-Size="17px" ForeColor="#1ecdb9" BackColor="#E0FFFF"  style="cursor:pointer" runat="server" CommandName="Edit" Text="修改信息" />
                 </td>
                 <td Style="text-align:center">
                      <asp:Button ID="DeleteButton" width="70px" Font-Size="17px" ForeColor="red" BackColor="#E0FFFF"  style="cursor:pointer" runat="server" CommandName="Delete" Text="删除账号" />
                 </td>
             </tr>
         </ItemTemplate>
         <LayoutTemplate>
         ...
         <SelectedItemTemplate>
             <tr style="background-color: #E2DED6;font-weight: bold;color: #333333;height:50px;">
                 ...
                 <td Style="text-align:center">
                      <asp:Button ID="DeleteButton" width="70px" Font-Size="17px" ForeColor="#1ecdb9" BackColor="White" style="cursor:pointer" runat="server" CommandName="Delete" Text="删除账号" />
                 </td>
             </tr>
         </SelectedItemTemplate>
     </asp:ListView>
