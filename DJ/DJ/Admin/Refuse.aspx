<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master.master" AutoEventWireup="true" CodeFile="Refuse.aspx.cs" Inherits="_Default" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:constr %>" SelectCommand="SELECT [M_ID], [W_Name], [W_Place], [W_Description], [W_People], [W_Time], [W_ReleaseTime], [W_Money] FROM [Table_Work] WHERE [W_State]='3' ORDER BY [M_ID], [W_ReleaseTime] DESC ">
    </asp:SqlDataSource>
</asp:Content>
