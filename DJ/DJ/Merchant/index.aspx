    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Panel ID="Panel1" runat="server" Height="73px">
                <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/Merchant/index.aspx" Font-Underline="false" ForeColor="#00b4aa" Style="margin-left: 5%">首页</asp:HyperLink>
        ...
        <div id="divv">
            ...
            <div id="div0">
                <div id="div1">
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Merchant/image/新报名1.png" ImageAlign="Middle" OnClick="ImageButton1_Click" />
                    <div id="div2">
                ...
                <div id="div3">
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Merchant/image/在招职位1.png" ImageAlign="Middle" OnClick="ImageButton2_Click" />
                    <div id="div4">
                ...
                <div id="div5">
                    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Merchant/image/未读消息1.png" ImageAlign="Middle" OnClick="ImageButton3_Click" />
                    <div id="div6">
