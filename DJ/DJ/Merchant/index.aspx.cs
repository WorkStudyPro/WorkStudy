...
public partial class index : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("http://localhost:56935/Merchant/management.aspx");
    }

    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("http://localhost:56935/Merchant/mynews.aspx");
    }

    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("http://localhost:56935/Merchant/Resume.aspx");
    }
    ...
    {
        Response.Redirect("http://localhost:56935/Merchant/myset.aspx");
    }
}