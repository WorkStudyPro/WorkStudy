...
<%@ Register Src="~/Merchant/FinishWork.ascx" TagPrefix="uc1" TagName="FinishWork" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="divv">
            ...
            <asp:HyperLink ID="HyperLinkssss" runat="server" ForeColor="white" NavigateUrl="~/Merchant/management4.aspx" Font-Underline="false">审核驳回</asp:HyperLink>
