    ...
    <form id="form1" runat="server">
       ...
       <div>
           <br /><br />
            <asp:Panel ID="Panel1" runat="server" Height="73px">
                <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/Merchant/index.aspx"  font-underline="false" ForeColor="white"   style="margin-left: 5%" >首页</asp:HyperLink>
                 ...
                 <asp:HyperLink ID="HyperLink10" runat="server" ForeColor="#00b4aa"  font-underline="false" NavigateUrl="~/Merchant/mynews.aspx"  style="margin-left: 5%">消息</asp:HyperLink>
                    <ul id="first">
			        <li>			
				<span></span>
        ...
        <div id="div0">
            <div id="div1">
                <br />
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Merchant/image/通知logo.png" Height="51px" Width="58px" ImageAlign="Middle" />
               
                <asp:Label ID="Label8" runat="server" Text="系统通知" Font-Size="17px"></asp:Label>
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Merchant/image/图标 18.svg"   Height="34px" Style="margin-left: 140px;margin-top: -15px;" ImageAlign="Middle"  Width="39px" />
            </div>
