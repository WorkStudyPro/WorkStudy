    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel3" runat="server">
            ...
            <asp:Panel ID="Panel4" runat="server" Height="190px" Width="200px" BackColor="white">
                ...
                <br />
                <br />
                <asp:HyperLink ID="HyperLink2" ForeColor="Black" Font-Underline="false" NavigateUrl="~/Merchant/mygs.aspx" runat="server">我的公司</asp:HyperLink>
            </asp:Panel>
            <asp:Panel ID="Panel5" runat="server" Height="200px" Width="200px" BackColor="white">
                <br />
                <br />
                <asp:HyperLink ID="HyperLink3" ForeColor="#00b4aa" Font-Underline="false" runat="server" NavigateUrl="~/Merchant/setpass.aspx">修改密码</asp:HyperLink>
                ...
                <asp:HyperLink ID="HyperLink6" ForeColor="Black" Font-Underline="false" runat="server" NavigateUrl="~/Merchant/login.aspx">退出登录</asp:HyperLink>
            </asp:Panel>
            <asp:Panel ID="Panel6" runat="server" Height="500px" Width="800px" BackColor="white">
                ...
                <br />
                <asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="180px" Font-Size="Medium" AutoCompleteType="Disabled"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" runat="server" ErrorMessage="*不能为空" ControlToValidate="TextBox1" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <br />
                <asp:TextBox ID="TextBox2" runat="server" Height="30px" Width="180px" Font-Size="Medium" AutoCompleteType="Disabled"></asp:TextBox><asp:CompareValidator ID="CompareValidator2" runat="server" ForeColor="Red" ErrorMessage="*原密码与新密码一样" ControlToValidate="TextBox2" ControlToCompare="TextBox1" Operator="NotEqual"></asp:CompareValidator>
                ...
                <br />
                <asp:TextBox ID="TextBox3" runat="server" Height="30px" Width="180px" Font-Size="Medium" AutoCompleteType="Disabled"></asp:TextBox><asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="*两次密码不相同" ControlToCompare="TextBox2" ForeColor="Red" ControlToValidate="TextBox3"></asp:CompareValidator>
                <br />
                <br />
                <br />
                <br />
