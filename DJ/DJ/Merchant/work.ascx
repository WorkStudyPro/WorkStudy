...
<%--        <asp:Label ID="name" runat="server" onclick="openDialog();" Style="margin-left: 8%; cursor: pointer;" Text="食堂打扫" Font-Bold="True" Font-Size="22px" ForeColor="#1ECDB9" ></asp:Label>--%>
    ...
    <div id="workright">
        <asp:Button ID="Button关闭兼职" runat="server" Text="关闭兼职" Style="width: 132px;border:none; height: 40px; line-height: 40px; float: right; background-color: #1ecdb9; border-radius: 6px; color: #fff; cursor: pointer; margin-top: -7%; margin-right: 4%;" OnClick="Button关闭兼职_Click" />
    </div>
</div>
