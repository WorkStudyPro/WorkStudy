...
<body>
    <form id="form1" runat="server">
       ...
       <div>
        ...
        <div id="divv">
            <br />
            <asp:HyperLink ID="HyperLinks" runat="server" font-underline="false" NavigateUrl="~/Resume.aspx" ForeColor="#00b4aa">待录取</asp:HyperLink>
            <asp:HyperLink ID="HyperLinkss" runat="server" ForeColor="white" NavigateUrl="~/Resume2.aspx" font-underline="false">已完成</asp:HyperLink>
