...
<%@ Register Src="~/work1.ascx" TagPrefix="uc1" TagName="work1" %>
...
<body>
   <form id="form1" runat="server">
       ...
       <div>
        ...
        <div id="divv">
            <br />
            <asp:HyperLink ID="HyperLinks" runat="server" ForeColor="white" NavigateUrl="~/management.aspx" font-underline="false" >招聘中</asp:HyperLink>
